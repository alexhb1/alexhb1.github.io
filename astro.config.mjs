...
const isForkPagesBuild =
  process.env.GITHUB_ACTIONS === 'true' &&
  githubRepositoryOwner !== 'grimmory-tools' &&
  githubRepositoryName === 'grimmory-docs';

export default defineConfig({
  site: isForkPagesBuild ? `https://${githubRepositoryOwner}.github.io` : 'https://grimmory.org',
  base: isForkPagesBuild ? `/${githubRepositoryName}` : undefined,
  fonts: [
    {
