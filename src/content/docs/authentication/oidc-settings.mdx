...
- [Authentik](/authentication/authentik)
- [Pocket ID](/authentication/pocket-id)
- [Authelia](/authentication/authelia)
...
<ThemeImage src={"/img/authentication/oidc-settings/login-methods.png"} alt={"Login Methods"} />
...
<ThemeImage src={"/img/authentication/oidc-settings/provider-configuration.png"} alt={"Provider Configuration"} />
### Connection Settings
...
<ThemeImage src={"/img/authentication/oidc-settings/provider-reference.png"} alt={"Provider Configuration Reference"} />
...
<ThemeImage src={"/img/authentication/oidc-settings/oidc-only-mode.png"} alt={"OIDC-Only Mode"} />
...
<ThemeImage src={"/img/authentication/oidc-settings/user-provisioning.png"} alt={"User Provisioning"} />
...
<ThemeImage src={"/img/authentication/oidc-settings/group-mapping.png"} alt={"Group Mapping"} />
### Group Sync Mode
