...
<ThemeImage src={"/img/authentication/pocket-id/create-client.jpg"} alt={"Create Client"} />
Fill in the client configuration:

<ThemeImage src={"/img/authentication/pocket-id/client-details.jpg"} alt={"Client Details"} />
| Field | Value | Notes |
|-------|-------|-------|
...
<ThemeImage src={"/img/authentication/pocket-id/copy-client-id.jpg"} alt={"Copy Client ID"} />
...
<ThemeImage src={"/img/authentication/pocket-id/grimmory-oidc-settings.jpg"} alt={"Grimmory OIDC Settings"} />
...
<ThemeImage src={"/img/authentication/pocket-id/app-card.jpg"} alt={"Grimmory App Card"} />
Click the **Grimmory** card. Pocket ID handles the authentication and redirects you to Grimmory.

<ThemeImage src={"/img/authentication/pocket-id/login-success.jpg"} alt={"Login Success"} />
...
- **[Group Mapping](/authentication/oidc-settings#group-mapping):** Map Pocket ID groups to Grimmory permissions and library access
- **[OIDC-Only Mode](/authentication/oidc-settings#-oidc-only-mode):** Hide the local login form and redirect everyone to Pocket ID
...
Auto-provisioning is off by default. Either enable it in [OIDC Settings](/authentication/oidc-settings#-user-provisioning), or create a Grimmory user with a username that exactly matches the Pocket ID username (case-sensitive).
