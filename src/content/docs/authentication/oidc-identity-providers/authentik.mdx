...
<ThemeImage src={"/img/authentication/authentik/create-application.jpg"} alt={"Create Application"} />
Fill in the application details:

<ThemeImage src={"/img/authentication/authentik/application-details.jpg"} alt={"Application Configuration"} />
...
<ThemeImage src={"/img/authentication/authentik/provider-type.jpg"} alt={"Choose Provider"} />
Choose **OAuth2/OpenID Provider** and click **Next**.

### Configure the Provider

<ThemeImage src={"/img/authentication/authentik/provider-settings.jpg"} alt={"Configure Provider"} />
...
<ThemeImage src={"/img/authentication/authentik/redirect-uris.jpg"} alt={"Redirect URIs"} />
...
<ThemeImage src={"/img/authentication/authentik/oauth-scopes.jpg"} alt={"OAuth Scopes"} />
...
<ThemeImage src={"/img/authentication/authentik/user-bindings.jpg"} alt={"Configure Bindings"} />
...
Create a group like `grimmory-users` in Authentik and bind it to the application. Then just add or remove users from the group instead of editing bindings each time. This also pairs well with Grimmory's [Group Mapping](/authentication/oidc-settings#group-mapping) feature.
:::
...
<ThemeImage src={"/img/authentication/authentik/providers-list.jpg"} alt={"Provider List"} />
<ThemeImage src={"/img/authentication/authentik/provider-credentials.jpg"} alt={"Provider Credentials"} />
...
<ThemeImage src={"/img/authentication/authentik/grimmory-oidc-settings.jpg"} alt={"Grimmory OIDC Settings"} />
...
<ThemeImage src={"/img/authentication/authentik/user-impersonation.jpg"} alt={"User Impersonation"} />
...
<ThemeImage src={"/img/authentication/authentik/login-page.jpg"} alt={"Authentik Login Page"} />
3. Click the **Grimmory** tile. You should be redirected and logged in automatically.

<ThemeImage src={"/img/authentication/authentik/grimmory-homepage.jpg"} alt={"Grimmory Homepage"} />
...
- **[Group Mapping](/authentication/oidc-settings#group-mapping):** Map Authentik groups to Grimmory permissions and library access (Authentik includes groups in the `groups` claim by default, no extra configuration needed)
- **[OIDC-Only Mode](/authentication/oidc-settings#-oidc-only-mode):** Hide the local login form and redirect everyone to Authentik
...
Auto-provisioning is off by default. Either enable it in [OIDC Settings](/authentication/oidc-settings#-user-provisioning), or create a Grimmory user with a username that exactly matches the Authentik `preferred_username` (case-sensitive).
