...
<ThemeImage src={"/img/authentication/authelia/grimmory-oidc-settings.jpg"} alt={"Grimmory OIDC Settings"} />
...
<ThemeImage src={"/img/authentication/authelia/login-success.jpg"} alt={"Login Success"} />
