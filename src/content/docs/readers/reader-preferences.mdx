...
<ThemeImage src={"/img/reader/settings-application-mode.jpg"} alt={"Settings Application Mode"} />
| Mode | Behavior |
|------|----------|
...
<ThemeImage src={"/img/reader/ebook-appearance.jpg"} alt={"eBook Appearance"} />
...
<ThemeImage src={"/img/reader/ebook-typography.jpg"} alt={"eBook Typography"} />
| Setting | Options | Default | Description |
|---------|---------|---------|-------------|
...
<ThemeImage src={"/img/reader/ebook-layout.jpg"} alt={"eBook Layout"} />
| Setting | Options | Default | Description |
|---------|---------|---------|-------------|
...
<ThemeImage src={"/img/reader/pdf-reader.jpg"} alt={"PDF Reader Settings"} />
| Setting | Options | Default | Description |
|---------|---------|---------|-------------|
...
<ThemeImage src={"/img/reader/comic-reader.jpg"} alt={"Comic Book Reader Settings"} />
| Setting | Options | Default | Description |
|---------|---------|---------|-------------|
...
<ThemeImage src={"/img/reader/custom-font-library.jpg"} alt={"Custom Font Library"} />
### Uploading Fonts
